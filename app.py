...
class RequestForm(FlaskForm):
    with open('goals.json', 'r') as f:
        goals = json.load(f)
    name = StringField('Вас зовут', validators=[InputRequired(message='Нужно ввести Ваше имя')])
    phone = StringField('Ваш телефон', validators=[InputRequired(message='Введите Ваш номер телефона')])
